...
$html_version = '<table width="100%" style="font-size: 11px; font-family: helvetica; margin: 5px; background-color: rgb(255,255,255);">'
. '<tr>'
.		'<td align="center">'
...
.          '<td style="font-size: 10px;text-transform:uppercase;color:rgb(205,205,205);padding:0 5px 0 0;" align="right">'. date("l, j F Y") .'</td>'
.				'</tr>'
.			'</table>'
.			'<table cellpadding="0" cellspacing="0" border="0" width="640" bgcolor="#fff" style="background-color: #fff; margin: 0 3px 0 3px;">'
.				'<tr>'
.          '<td><a href="'. site_url() . '"><img src="http://www.thegreenpages.com.au/wp-content/uploads/2012/01/header1.png" alt="header" width="554" height="80" border="0" /></a></td>'
...
.                '<td align="center"><a href="'. site_url() .'/news/" style="text-decoration:none;font-weight:; color:#fff;font-size: 13px;">News</a></td>'
.                '<td align="center"><a href="'. site_url() .'/events" style="text-decoration:none; font-weight:; color:#fff;font-size: 13px;">Events</a></td>'
.                '<td align="center"><a href="'. site_url() .'/new-stuff" style="text-decoration:none; font-weight:; color:#fff;font-size: 13px;">New Stuff</a></td>'
.                '<td align="center"><a href="'. site_url() .'/competitions" style="text-decoration:none; font-weight:; color:#fff;font-size: 13px;">Competitions</a></td>'
.                '<td align="center"><a href="'. site_url() .'/people/" style="text-decoration:none; font-weight:; color:#fff;font-size: 13px;">People</a></td>'
.                '<td align="center"><a href="'. site_url() .'/ngo-campaign" style="text-decoration:none; font-weight:; color:#fff;font-size: 13px;">Campaigns</a></td>'
.							'</tr>'
.						'</table>'
.					'</td>'
.'<!--TOP NAV BAR ENDS-->					'
...
.					'<td width="490" style="padding: 0 0 0 5px;" valign="top">';
  ...
  while( $the_query->have_posts()) {
    $the_query->the_post();
		$html_version .=				'<!-- Repeater1 for News Content Starts -->'
...
.                        transform_post_html(get_the_excerpt())
.                        '<br />'
.                        '<br />'
.                        '<a href="' . get_permalink() . '" style="text-decoration: none; color: #01AED8; font-weight: bold;">Continue reading...</a> '
...
.				'<tr>'
.          '<td style="font-size: 10px; color: #fff; background-color: rgb(97,194,1); height: 40px; padding:5px 0 5px 5px;">THE GREEN RAZOR is delivered to you by Green Pages, The Hub of Sustainability<a href="' . site_url() . '" alt="greenpages" width="198" height="20" align="absmiddle" border="0"></a></td>'
