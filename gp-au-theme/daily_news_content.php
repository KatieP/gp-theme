...
<?php
  ...
  echo "THE GREEN RAZOR: Your daily news from the Green Pages Community\n"; 

  echo str_pad("",$text_width,"=",STR_PAD_LEFT) . "\n\n";

  while( $the_query->have_posts()) {
    $the_query->the_post();

    echo wordwrap(get_the_title(),$text_width) . "\n";
    echo str_pad("",$text_width,"-",STR_PAD_LEFT) . "\n\n";

    echo wordwrap(trim(strip_tags(get_the_excerpt())), $text_width);

    echo "\n\n";
    echo wordwrap("read more at: " . get_permalink(), $text_width); 
  ...
  echo "THE GREEN RAZOR is delivered to you by\n";
  echo "Green Pages, The Hub of Sustainability\n";

  echo "\n";

  echo "find us on:\n";
  echo "* facebook: http://www.facebook.com/pages/Green-Pages-Community/135951849770296?ref=ts\n";
  echo "* twitter: http://twitter.com/GreenPagesAu\n";
  ...
  echo "feedback: http://www.thegreenpages.com.au/index.asp?page_id=23\n";
  echo "send a story idea: mailto:editor@thegreenpages.com.au\n";
  echo "add a gp link to your site: http://www.thegreenpages.com.au/index.asp?page_id=290\n";
  echo "advertise: http://www.thegreenpages.com.au/index.asp?page_id=17\n";
  echo "contact us: http://www.thegreenpages.com.au/index.asp?page_id=23\n";

  echo "\n";

  echo str_pad("",$text_width,"- ", STR_PAD_LEFT) . "\n\n";

  echo "© 2011 Green Pages Pty Ltd functions under Creative Commons Copyright.\n";
  echo "No vibes were harmed making this website.\n";
