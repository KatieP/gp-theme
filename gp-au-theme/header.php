    		...
    		<div class="pos">
                ...
                if ( ( !is_page() || ( strpos($_SERVER['REQUEST_URI'], '/world-map/' ) === 0 ) ) ) {
    				...
    				<div class="post-details" id="header-tagline">
	            		Everything environmental happening around <span id="header_user_location" class=""><a href="#" onclick="show_location_field(); return false;"><?php echo $location_filter; ?></a>.</span>
